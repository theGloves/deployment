...
#发送tendermint文件到各个站点
scp -i $workdir/key/ruc_500_new $workdir/files/tendermint.tar centos@10.77.70.138:/home/centos/$2/tendermint.tar
echo "send done"
#各个站点删除镜像和载入镜像

ssh -i $workdir/key/ruc_500_new  centos@10.77.70.138  "cd /home/centos/$2;sudo docker rmi 10.77.70.142:5000/tendermint:v0.4;sudo docker load < tendermint.tar;sudo docker tag tendermint1:latest 10.77.70.142:5000/tendermint:v0.4;sudo docker push 10.77.70.142:5000/tendermint:v0.4"

echo "load done"	
ssh -i $workdir/key/ruc_500_new  centos@10.77.70.135 "sudo docker rmi 10.77.70.142:5000/tendermint:v0.4;sudo docker pull 10.77.70.142:5000/tendermint:v0.4"&
##由于136不可链接
